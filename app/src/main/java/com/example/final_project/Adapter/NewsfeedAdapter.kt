...
import com.example.final_project.screen.ProfileActivity
...
class NewsfeedAdapter(options: FirestoreRecyclerOptions<Newsfeed>) :
    FirestoreRecyclerAdapter<Newsfeed, NewsfeedAdapter.NewsfeedViewHolder>(options) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NewsfeedViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_view_news_feed, parent, false)
    ...
    class NewsfeedViewHolder(private val view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(newsfeed: Newsfeed) {
            ...
            profileView.setOnClickListener {
                ...
                val postUserId = newsfeed.userId // ID of the user who created the post
